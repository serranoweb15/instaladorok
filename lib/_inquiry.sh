...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu DevWhats que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador DevWhats, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar DevWhats\n"
  printf "   [1] Atualizar DevWhats\n"
  printf "   [2] Deletar DevWhats\n"
  printf "   [3] Bloquear DevWhats\n"
  printf "   [4] Desbloquear DevWhats\n"
  printf "   [5] Alter. dominio DevWhats\n"
  printf "\n"
  read -p "> " option
